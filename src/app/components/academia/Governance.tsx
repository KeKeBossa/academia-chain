...
export function Governance() {
  ...
  const [proposals, setProposals] = useState<Proposal[]>([
    {
      ...
      description:
        '量子機械学習（Quantum Machine Learning）を新しい研究分野カテゴリとして追加することを提案します。この分野は急速に成長しており、多くの研究者が関心を持っています。',
      proposer: '山田 花子',
    ...
    },
    {
      ...
      description:
        '共同研究プロジェクトへの助成金配分において、参加大学数だけでなく、学際性や社会的インパクトも評価基準に含めることを提案します。',
      proposer: '佐藤 健',
    ...
    },
    {
      ...
      title: '査読システムの透明性向上',
      description:
        'ブロックチェーン上で査読プロセスの記録を公開し、査読者の匿名性を保ちつつ透明性を高めるシステムの導入を提案します。',
      proposer: '鈴木 美咲',
  ...
  const handleCreateProposal = () => {
    ...
    if (myVotingPower < tokensRequired) {
      toast.error(
        `提案に必要なトークンが不足しています（必要: ${tokensRequired}、保有: ${myVotingPower}）`
      );
      return;
    }
