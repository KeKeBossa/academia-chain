        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl mb-1">
              {seminars.reduce((acc, s) => acc + s.activeProjects, 0)}
            </div>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Combobox
                  ...
                  placeholder={
                    newSeminar.university ? '学部を選択または入力...' : '大学を先に選択してください'
                  }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: string) => setNewSeminar({ ...newSeminar, field: value })}
              >
                <SelectTrigger>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-blue-900">ID（DID）が自動的に発行されます</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <Hash className="w-4 h-4 text-blue-600" />
